...
#define MY_GREEN_LED 12
#define MY_RED_LED 11
...
bool RespondToKWS(tflite::ErrorReporter* error_reporter, const char* found_command, bool is_new_command, int8_t score){
  ...
  if (is_new_command) {
    ...
    if (found_command[0] == 'a') {
      digitalWrite(LEDB, LOW);  // Onboard Blue for alexa
      return true;
    }
  }
...
void RespondToDetection(tflite::ErrorReporter* error_reporter,
  ...
  TF_LITE_REPORT_ERROR(error_reporter, "Masked score: %d Unmasked score: %d",
